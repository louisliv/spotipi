...
sudo systemctl stop spotipiservice-notifications
...
sudo systemctl disable spotipiservice-notifications
...
sudo systemctl enable spotipiservice-notifications
...
sudo systemctl start spotipiservice-notifications
